...
export default function BookingList() {
  const {bookings} = usePage<Props>().props;
        ...
        <div className="-m-1.5 overflow-x-auto">
          <div className="p-1.5 min-w-full inline-block align-middle">
            ...
            alt={booking.professional.name}/>
                          ...
                          <div className="grow">
                            <span
                              className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{booking.professional.name}</span>
                            <span
                              className="block text-sm text-gray-500 dark:text-neutral-500">{booking.professional.email}</span>
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="h-px w-72 whitespace-nowrap">
                      <div className="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                        <div className="flex items-center gap-x-3">
                          <div
                            className="w-16 h-16 rounded-md flex items-center justify-center bg-blue-200">
                    ...
                    <td className="size-px whitespace-nowrap">
                      <div className="px-6 py-3">
                        <span className="text-sm text-gray-500 dark:text-neutral-500">{booking.created_at}</span>
                      </div>
                    </td>
                    <td className="size-px whitespace-nowrap">
