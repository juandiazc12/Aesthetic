...
export default function PQRS() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Su PQRS ha sido enviado exitosamente. Le responderemos en un plazo máximo de 15 días hábiles.');
  };
  ...
  const pqrsTypes = [
    { value: 'peticion', label: 'Petición', description: 'Solicitud respetuosa de información o documentos' },
    { value: 'queja', label: 'Queja', description: 'Manifestación de inconformidad con un servicio' },
    { value: 'reclamo', label: 'Reclamo', description: 'Solicitud de solución a un problema específico' },
    { value: 'sugerencia', label: 'Sugerencia', description: 'Propuesta para mejorar nuestros servicios' }
  ];
        ...
        <div className="max-w-4xl mx-auto py-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {pqrsTypes.map((type, index) => (
              <div key={index} className="bg-white dark:bg-neutral-800 p-4 rounded-lg shadow-lg border-l-4 border-blue-600">
          ...
          <div className="mt-12 bg-gray-50 dark:bg-neutral-800 rounded-xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Respuesta en 24-48 horas</p>
              </div>
              
              <div className="text-center">
                <div className="text-3xl mb-3">💬</div>
                <h4 className="font-medium text-gray-900 dark:text-white mb-2">WhatsApp</h4>
                <p className="text-gray-600 dark:text-gray-300">+57 321 770 6324</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Lun - Vie: 8:00 AM - 6:00 PM</p>
              </div>
            </div>
