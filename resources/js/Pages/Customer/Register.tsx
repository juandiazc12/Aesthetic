                ...
                <div className="p-4 sm:p-7">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                            ...
                            <a className="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                    ...
                    <div className="mt-5">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid gap-y-4">
                                <div>
                                    <label htmlFor="first_name" className="block text-sm mb-2 dark:text-white">First
                                        name</label>
                                    ...
                                    <p className="hidden text-xs text-red-600 mt-2" id="email-error">Please include a
                                        valid first name so we can get back to you</p>
                                </div>

                                <div>
                                    <label htmlFor="last_name" className="block text-sm mb-2 dark:text-white">Last
                                        name</label>
                                    <div className="relative">
